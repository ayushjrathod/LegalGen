...
const Dropdown = () => {
  ...
  useEffect(() => {
    if (btnDropdownRef.current && popoverDropdownRef.current) {
      popperRef.current = createPopper(btnDropdownRef.current, popoverDropdownRef.current, {
  ...
  return (
    <>
      <div className="inline-flex align-middle z-50 mx-3">
        ...
        >
          <img src="../assets/userIcon.jpg" className="size-10 rounded-full border-2 p-0.5" />
        </button>
        <div
